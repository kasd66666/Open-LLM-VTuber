...
def parse_args():
    ...
    parser.add_argument("--config", default="conf.yaml", help="Configuration file to use")
    return parser.parse_args()


@logger.catch
def run(console_log_level: str, config_file: str = "conf.yaml", host: str = None, port: int = None):
    ...
    config: Config = validate_config(read_yaml(config_file))
    server_config = config.system_config

    # Override host and port if provided via command line or environment
    if host:
